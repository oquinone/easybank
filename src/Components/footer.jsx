...
class Footer extends Component {
    ...
    render() { 
        return (
            <footer id="footer" className="flex-sb p-lr">
                <div id="footer-logo-socials" className="flex-se">
                    <div id="footer-logo">
                ...
                <div id="footer-links-container" className="flex-sb">
                    <ul className="test">
                        <li>About Us</li>
                        <li>Contact</li>
                        <li>Blog</li>
                ...
                <div id="footer-btn-copyright" className="flex-se">
                    <div id="btn"><button class="btn">Request Invite</button></div>
                    <div id="copyright"><h6>&#169; Easybank. All Rights Reserved</h6></div>
                </div>
            </footer>
        );
    }
